...
class mim_wizard(models.TransientModel):
	...
	def calcul(self):
		...
		img_path = modules.get_module_resource('mim_module_migrated', 'static/src/img', (image_name))
...
class sale_order(models.Model):
	...
	def action_mim_wizard(self):
		...
		res = mod_obj.get_object_reference('mim_module_migrated', 'view_mim_wizard')
